-- Made By EggTargaryen, HeyBoxUID: 1310911, V1.4
-- https://github.com/dzxrly/MHR-ItemSetAutoResupplyMod
-- MIT License
local fontName = "NotoSansSC-Regular.otf"
local fontSize = 18
local chineseGlyphRanges = {
    0x0020, 0xFFEE,
    0,
}
local font = imgui.load_font(fontName, fontSize, chineseGlyphRanges)
